# -*- coding: utf-8 -*-
"""EYASE using Parallel CNN Attention LSTM.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/10tthhX9ZCCQWn1UdCbZgbSxsJWxqlj7y
"""
...
MODEL_DIR = os.path.join(os.getcwd(), 'model_export')
os.makedirs(MODEL_DIR, exist_ok=True)

# 1. Save model weights in safetensors format
model_state = model.state_dict()
save_file(model_state, os.path.join(MODEL_DIR, "model.safetensors"))

# 2. Create config.json with model architecture details
config = {
    "model_type": "parallel_cnn_lstm",
    ...
    "architecture": "ParallelModel"
}
with open(os.path.join(MODEL_DIR, "config.json"), "w") as f:
    json.dump(config, f, indent=2)

# 3. Create preprocessor_config.json with preprocessing info
preprocessor_config = {
    ...
    "input_shape": [1, 128, 563]
}
with open(os.path.join(MODEL_DIR, "preprocessor_config.json"), "w") as f:
    json.dump(preprocessor_config, f, indent=2)

# 4. Create tokenizer-related files (although not strictly needed for audio models,
#    some frameworks expect these files)
special_tokens_map = {
    "emotion_tokens": list(EMOTIONS.values())
}
with open(os.path.join(MODEL_DIR, "special_tokens_map.json"), "w") as f:
    json.dump(special_tokens_map, f, indent=2)

tokenizer_config = {
    "feature_type": "melspectrogram_audio",
...
# 5. Save scaler parameters for future use
scaler_params = {
...
# 6. Zip all files
with zipfile.ZipFile('eyase_emotion_model.zip', 'w') as zipf:
...
print(f"Model saved successfully to 'eyase_emotion_model.zip' with all configuration files.")
print(f"The zip file contains:")
with zipfile.ZipFile('eyase_emotion_model.zip', 'r') as zipf:
